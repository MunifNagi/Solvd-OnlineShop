...
public class UserServiceTest {
    ...
    public void createUser() {
        user = new User(10, "Alex", "John", "A", "347-000-0000", "Alex@test.com", "Alex1234");
    }
    ...
    public void testCreateUser() {
        ...
        Assert.assertEquals(userService.getAllUsers().size(), numUsers + 1, "Number of users should have been incremented after insertion");
    }
    ...
    public void testUpdateUser() {
        User testUser = userService.getUserByID(10);
